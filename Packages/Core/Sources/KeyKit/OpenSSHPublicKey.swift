...
public enum OpenSSHPublicKey {
    ...
    public static func line(forEd25519 publicKey: Curve25519.Signing.PublicKey, comment: String) -> String {
        var blob = Data()
        appendString(Data("ssh-ed25519".utf8), to: &blob)
        appendString(publicKey.rawRepresentation, to: &blob)
