    ...
    public struct VNCScreenView: View {
        ...
        public var body: some View {
            ...
            .alert("Add shortcut", isPresented: $addingShortcut) {
                ...
                Text(
                    "Modifiers: cmd, shift, ctrl, alt. Keys: letters, digits, space, tab, esc, return, arrows, f1-f19.")
            }
            .onDisappear {
                session.disconnect()
            }
        ...
        private func controlButton(_ systemImage: String, active: Bool = false, action: @escaping () -> Void)
            -> some View
        {
        ...
        private func addShortcut() {
            ...
            guard let combo = VNCKeyCombo.parse(text),
                ...
                !VNCKeyCombo.presets.contains(combo)
            else { return }
